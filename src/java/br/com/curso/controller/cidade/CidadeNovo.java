...
public class CidadeNovo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cidade oCidade = new Cidade(); //cria objeto cidade vazio e seta o id como zero
        request.setAttribute("cidade",oCidade);
        EstadoDAO oEstadoDAO = new EstadoDAO(); //busca a lista para alimentar a caixa de seleção na view (jsp)
